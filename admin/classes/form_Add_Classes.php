...
<main class="min-h-screen flex items-center justify-center p-6">
    ...
    <div class="glass-card w-full max-w-2xl rounded-2xl shadow-2xl p-8 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <form class="grid grid-cols-1 md:grid-cols-2 gap-5" method="POST" action="../../scripts/add_Class.php">
                <!-- First Name -->
                <div class="space-y-1">
                    <label class="text-xs font-semibold text-gray-400 uppercase tracking-wider ml-1">Name</label>
                    <input type="text" name="name" 
                        class="input-style w-full p-3 rounded-xl">
                </div>
                <!-- Last Name -->
                <div class="space-y-1">
                    <label class="text-xs font-semibold text-gray-400 uppercase tracking-wider ml-1">ClassRoom_Number</label>
